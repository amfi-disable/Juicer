    ...
    func buildInsights() {
        ...
        var items: [InsightItem] = [
            ...
            InsightItem(name: "System Logs",
                        ...
                        category: .system,
                        riskLevel: .safe),
            InsightItem(name: "System Temporary Files",
                        path: "/tmp",
                        description: "Temporary files shared by macOS and running processes.",
                        category: .system,
                        riskLevel: .caution),
            InsightItem(name: "User Caches",
                        path: "\(home)/Library/Caches",
                        description: "Per-user application caches that can be rebuilt after cleanup.",
                        category: .system,
                        riskLevel: .safe),
            InsightItem(name: "System Caches",
                        path: "/Library/Caches",
                        description: "Shared application and system caches; some entries may require administrator access.",
                        category: .system,
                        riskLevel: .caution),
