...
struct codesnippetsview: View {
    ...
    var filtered: [CodeSnippet] { snippets.filter { query.isEmpty || $0.title.localizedCaseInsensitiveContains(query) || $0.language.localizedCaseInsensitiveContains(query) } }
